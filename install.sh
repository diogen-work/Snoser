Создатель - @webdeleted (tg) ДИОГЕН

import telebot
from telegraph import Telegraph, TelegraphException
from telebot.types import InlineKeyboardMarkup, InlineKeyboardButton

TOKEN = '7379847112:AAGvrXA1A6hWGKzoXqKmBRfmpA6rTpPmysE' #МЕЖДУ КОВЫЧЕК ТОКЕН БОТА В @BOTFATHER
...
bot.polling()
# СОЗДАТЕЛЬ ЭТОГО БОТА @webdeleted (ДИОГЕН)